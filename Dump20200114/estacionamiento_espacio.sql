...
CREATE TABLE `espacio` (
  ...
  `numEspacio` int(11) DEFAULT NULL,
  `idEstacionamiento` int(11) DEFAULT NULL,
  PRIMARY KEY (`idespacio`),
  KEY `kEspacioEstaciona_idx` (`idEstacionamiento`),
  CONSTRAINT `kEspacioEstaciona` FOREIGN KEY (`idEstacionamiento`) REFERENCES `estacionamiento` (`idestacionamiento`)
...
INSERT INTO `espacio` VALUES (0,0,1,0),(1,0,2,0),(2,1,3,0);
